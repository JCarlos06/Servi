...
public class Empleado extends javax.swing.JFrame {
    ...
    public Empleado() throws SQLException {
        ...
        InicioEmpleados inicio=new InicioEmpleados();
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        try {
            ...
            TrabajosEmpleados trbem=new TrabajosEmpleados();
            MostrarVentana(trbem);
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        try {
            // TODO add your handling code here:
            PagosEmpleados pagoem=new PagosEmpleados(codigo);
            MostrarVentana(pagoem);
        } catch (SQLException ex) {
            Logger.getLogger(Empleado.class.getName()).log(Level.SEVERE, null, ex);
        }
